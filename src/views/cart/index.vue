    ...
    <div class="container">
      ...
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120"><XtxCheckbox @change="($event) => checkAll($event)" :modelValue="$store.getters['cart/isCheckAll']">全选</XtxCheckbox></th>
          ...
          <tbody>
            <tr v-for="goods in $store.getters['cart/validList']" :key="goods.skuId">
              ...
              <td class="tc">
                <XtxNumbox @change="$event => updateCount(goods.skuId, $event)" :modelValue="goods.count" :max="goods.stock"/>
              </td>
              <td class="tc"><p class="f16 red">&yen;{{Math.round(goods.nowPrice * goods.count).toFixed(2)}}</p></td>
              <td class="tc">
          ...
          <tbody>
            ...
            <tr v-for="goods in $store.getters['cart/inValidList']" :key="goods.skuId">
              <td><XtxCheckbox @change="($event) => checkOne(goods.skuId, $event)" style="color:#eee;" /></td>
              <td>
                <div class="goods">
              ...
              <td class="tc"><p>&yen;{{Math.round(goods.nowPrice * goods.count).toFixed(2)}}</p></td>
              <td class="tc">
                <p><a @click="deleteCart(goods.skuId)" class="green" href="javascript:;">删除</a></p>
                <p><a href="javascript:;">找相似</a></p>
              </td>
